...
(function(f) {
  ...
  */
  ...
  function _placeTooltip(
    ...
    currentStepObj = currentIntroItem;
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer !== null) {
      ...
      self._lastShowElementTimer = window.setTimeout(function() {
        ...
        } else if (nextTooltipButton != null) {
  ...
  function _addOverlayLayer(targetElm) {
    ...
    overlayLayer.onclick = function() {
      if (
        self._options.exitOnOverlayClick === true &&
        (!self._options.preventExitOnOverlayClickUnlessDoneButtonIsPresent ||
          _doesSkipButtonRepresentDone.call(self))
      ) {
        if (
          _isOnLastStep.call(self) &&
          typeof self._introCompleteCallback === 'function'
        ) {
          self._introCompleteCallback.call(self);
        }
